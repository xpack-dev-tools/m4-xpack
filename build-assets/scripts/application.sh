...
XBB_APPLICATION_NAME=${XBB_APPLICATION_NAME:-"GNU M4"}

# Used as part of file/folder paths.
XBB_APPLICATION_LOWER_CASE_NAME=${XBB_APPLICATION_LOWER_CASE_NAME:-"m4"}
...
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( m4 libiconv )
