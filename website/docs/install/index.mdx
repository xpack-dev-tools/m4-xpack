...
- <code>xpack-m4-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-m4-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-m4-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-m4-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-m4-{customField('xpackVersion')}-linux-arm.tar.gz</code>
