...
The **xPack GNU M4** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack GNU M4
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/m4/1.4.20-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/xpack-dev-tools/m4/1.4.20-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-m4-1.4.20-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-m4-1.4.20-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/m4/xpack-m4-1.4.20-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/m4
cd ~/Library/xPacks/m4

tar xvf ~/Downloads/xpack-m4-1.4.20-1-darwin-x64.tar.gz
chmod -R -w xpack-m4-1.4.20-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-m4-1.4.20-1-linux-x64.tar.gz</code></li>
<li><code>xpack-m4-1.4.20-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/m4/xpack-m4-1.4.20-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/m4
cd ~/.local/xPacks/m4

tar xvf ~/Downloads/xpack-m4-1.4.20-1-linux-x64.tar.gz
chmod -R -w xpack-m4-1.4.20-1
`} </CodeBlock>
