...
`% ~/Library/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-1.4.19-3/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-1.4.19-3/bin/${props.programName} --version
${props.branding}1.4.19
`} </CodeBlock>
