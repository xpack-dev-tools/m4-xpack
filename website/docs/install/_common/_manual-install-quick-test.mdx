...
`% ~/Library/xPacks/${props.shortName}/xpack-${props.shortName}-1.4.19-3/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.shortName}/xpack-${props.shortName}-1.4.19-3/bin/${props.programName} --version
${props.branding}1.4.19
`} </CodeBlock>
