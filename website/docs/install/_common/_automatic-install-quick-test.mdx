...
`% ~/Library/xPacks/@xpack-dev-tools/${props.permalinkName}/1.4.19-3.1/.content/bin/${props.programName} --version
${props.branding}1.4.19
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.permalinkName}/1.4.19-3.1/.content/bin/${props.programName} --version
${props.branding}1.4.19
`} </CodeBlock>
