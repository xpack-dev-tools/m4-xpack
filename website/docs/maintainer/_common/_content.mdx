...
npm --prefix ~/Work/xpack-dev-tools/m4-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
npm --prefix ~/Work/xpack-dev-tools/m4-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
