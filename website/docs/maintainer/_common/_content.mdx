...
and fix them; assign them to a milestone (like <code>1.4.19-3</code>).
...
- add a new entry like _**\* v1.4.19-3 prepared**_
- commit with the message _**prepare v1.4.19-3**_
...
```sh
rm -f ~/Work/xpack-dev-tools/m4-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/m4-xpack.git pull

xpm run install -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets

git -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git pull
xpm link -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git

xpm run link-deps -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets

xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
(like **1.4.19**) with the following expression:
...
sequence, for each platform (macOS, GNU/Linux),
and check the
...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/m4-xpack.git
```
...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
```sh
xpm run clear-all-projects-builds -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
[GitHub Actions](https://github.com/xpack-dev-tools/m4-xpack/actions) page.
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
git -C ~/Work/xpack-dev-tools/m4-xpack.git pull
xpm run install -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
xpm run test-pre-release -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-publish-release -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
```sh
xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```

- edit the front matter properties
- select the correct summary
- commit with the message _**website: blog post release 1.4.19-3 published**_
...
```sh
xpm run update-package-binaries -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
- commit all changes with the message
  _**package.json: update urls for 1.4.19-3.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v1.4.19-3.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v1.4.19-3.1**_
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/m4?activeTab=versions">npmjs.com</a>.
...
```sh
xpm run trigger-workflow-test-xpm -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
- open https://xpack-dev-tools.github.io/m4-xpack/docs/maintainer/#publish-the-website in a separate window
...
in https://xpack-dev-tools.github.io/m4-xpack/blog/
- remember the post URL, since it must be used to update the release page
and the X/Twitter announcement
- switch to https://xpack-dev-tools.github.io/m4-xpack/docs/maintainer/#update-the-xpack-branch
...
```sh
xpm run trigger-workflow-deep-clean -C ~/Work/xpack-dev-tools/m4-xpack.git/build-assets
```
...
- paste the release name like _**xPack GNU M4 v1.4.19-3 released**_
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fm4?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/m4/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fm4)](https://www.npmjs.com/package/@xpack-dev-tools/m4/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fm4)](https://www.npmjs.com/package/@xpack-dev-tools/m4/)
