...
upstream {props.upstreamName ? props.upstreamName : 'GNU M4'} project
is a three-number string
such as <code>1.4.20</code>;
...
such as <code>1.4.20-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>1.4.20-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack GNU M4 dependency via
SemVer expressions
such as <code>^1.4.20-1</code> or <code>~1.4.20-1</code>, and
prefer exact matches,
such as <code>1.4.20-1.1</code>.
