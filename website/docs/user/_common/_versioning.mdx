...
like <code>1.4.19-<b>3</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>1.4.19-3.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack GNU M4 dependency via
a SemVer expressions
like <code>^1.4.19-3</code> or <code>~1.4.19-3</code>, and
