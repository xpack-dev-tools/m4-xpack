...
title: Information for xPack GNU M4 maintainers
...
```sh
bash ~/Work/xpack-dev-tools/m4-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack GNU M4 v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/m4</code>
- <code>npm dist-tag add @xpack-dev-tools/m4@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/m4</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/m4@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/m4-xpack/blog/
...
- paste the release name like _**xPack GNU M4 v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
