...
**xPack GNU M4** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU M4,
intended for reproducible builds.

<Overview/>

**xPack GNU M4** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/m4-xpack/tree/xpack/scripts).
