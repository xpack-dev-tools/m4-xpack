...
title: Getting Started with xPack GNU M4
...
**xPack GNU M4** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of GNU M4,
intended for reproducible builds.

<Overview/>

The open source **xPack GNU M4** project is hosted on GitHub as
[`xpack-dev-tools/m4-xpack`](https://github.com/xpack-dev-tools/m4-xpack);
it provides the platform specific binaries as
[release assets](https://github.com/xpack-dev-tools/m4-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/m4-xpack/tree/xpack/build-assets/scripts).
...
[GitHub Discussions](https://github.com/xpack-dev-tools/m4-xpack/discussions/).
...
[`m4-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/m4-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/m4-xpack/): It helps others discover our work.
